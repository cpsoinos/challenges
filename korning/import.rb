...
employee_data = (sales_data.map { |element| employee_data << element[:employee] })[0].to_set
...
customer_data = []
customer_data = (sales_data.map { |element| customer_data << element[:customer_and_account_no] })[0].to_set
