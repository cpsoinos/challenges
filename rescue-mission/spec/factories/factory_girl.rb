FactoryGirl.define do
  ...
  factory :answer do
    description "Seriously just do the thing. That's all you need. No minimum length, no maximum length, i don tknow why i'm stil typing is this long enough??? i sur ehope so. "
    question_id 123
    user_id 123
  end
end
